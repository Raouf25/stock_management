...
VALUES
    ('Impressions','VALPRIMER','1.000 KG',8.656,10.300, 150, 150, 1, trunc(random()*10000000000000)),
    ('Impressions','VALPRIMER','4.000 KG',30.311,36.071, 150, 150,  1, trunc(random()*10000000000000)),
    ('Impressions','VALPRIMER','18.000 KG',126.450,150.476, 150, 150,  1, trunc(random()*10000000000000)),
    ('Impressions','VALFIX','1.000 KG',8.209,9.769, 150, 150,  1, trunc(random()*10000000000000)),
    ('Impressions','VALFIX','4.000 KG',27.744,33.015, 150, 150,  3, trunc(random()*10000000000000)),
    ('Impressions','VALFIX','18.000 KG',118.260,140.729, 150, 150,  3, trunc(random()*10000000000000)),
    ('Impressions','FISSATIVO 30G','0.800 LT',15.236,18.131, 150, 150,  3, trunc(random()*10000000000000)),
    ('Impressions','FISSATIVO 30G','4.000 LT',62.384,74.238, 150, 150,  3, trunc(random()*10000000000000)),
    ('Impressions','FISSATIVO 30G','10.000 LT',142.788,169.918, 150, 150,  3, trunc(random()*10000000000000)),
    ('FINITIONS','VALMAT','1.000 KG',3.343,3.978, 150, 150,  3, trunc(random()*10000000000000)),
    ('FINITIONS','VALMAT','5.000 KG',11.031,13.127, 150, 150,  3, trunc(random()*10000000000000)),
    ('FINITIONS','VALMAT','23.000 KG',45.418,54.047, 150, 150,  3, trunc(random()*10000000000000)),
    ('FINITIONS','VALMAT','40.000 KG',69.907,83.190, 150, 150,  3, trunc(random()*10000000000000)),
