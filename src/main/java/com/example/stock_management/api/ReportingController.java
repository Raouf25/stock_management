...
public class ReportingController {
    ...
    /**
     * Récupérer les alertes de stock avec un seuil configurable
     */
    @GetMapping("/alerts")
    @Operation(summary = "Récupérer les alertes de stock avec seuil personnalisé")
    public ResponseEntity<List<StockAlertDTO>> getStockAlertsWithThreshold(
