        ...
        <div style="padding: 0.75rem 1rem; border-bottom: 1px solid #e5e7eb;">
          <div style="position: relative;">
            ...
            <input type="text" 
                   ...
                   style="width: 100%; padding: 0.625rem 0.75rem 0.625rem 2.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem; font-size: 0.875rem;">
          </div>
        </div>
...
export class ProductCatalogComponent implements OnInit, OnChanges {
  ...
  selectProduct(product: Product): void {
    if (this.getAvailableStock(product) > 0) {
      // Ensure both id properties are set for compatibility
