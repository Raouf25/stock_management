...
export class ToastService {
  ...
  success(message: string, duration = 4500): void { this.show(message, 'success', duration); }
  error(message: string,   duration = 5500): void { this.show(message, 'error',   duration); }
  warning(message: string, duration = 5000): void { this.show(message, 'warning', duration); }
  info(message: string,    duration = 4500): void { this.show(message, 'info',    duration); }
